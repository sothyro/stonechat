...
import '../consultations/dashboard_calendar.dart';

/// Appointments calendar and list for the unified admin hub (requires auth on parent).
class AppointmentsAdminTab extends StatefulWidget {
  const AppointmentsAdminTab({super.key});

  @override
  State<AppointmentsAdminTab> createState() => _AppointmentsAdminTabState();
}

class _AppointmentsAdminTabState extends State<AppointmentsAdminTab> {
