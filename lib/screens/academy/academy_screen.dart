...
class AcademyScreen extends StatelessWidget {
            ...
            child: Center(
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    _buildSectionHeadline(context, l10n.academyPageTitle),
  ...
  /// Builds a simple section headline (e.g. for "Learning & Training").
  static Widget _buildSectionHeadline(BuildContext context, String text) {
    return Text(
      text,
...
/// Includes marketing overlay: headline + Book Consultation CTA.
class _AcademyHero extends StatelessWidget {
  const _AcademyHero({required this.isDesktop, required this.l10n});
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              bottom: 0,
              child: Padding(
                padding: EdgeInsets.fromLTRB(isNarrow ? 24 : 48, 32, isNarrow ? 24 : 48, 56),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
