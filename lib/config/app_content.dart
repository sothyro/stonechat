...
class AppContent {
  ...
  static const String legalEntity = 'Master Elf Feng Shui';
  ...
  static const String office1Address = addressLine;
  static const String office1Phone = '+855 12 222 211';
  static const String office1PhoneSecondary = '+855 90 222 211';

  // §4 Social (empty = not set; add URLs when provided)
  static const String? facebookUrl = null;
  static const String? instagramUrl = null;
  static const String? tiktokUrl = null;
  ...
  static const String assetLogo = 'assets/icons/icon.png';
